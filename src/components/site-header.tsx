      ...
      <div className="mx-auto flex h-[4.25rem] max-w-6xl min-w-0 items-center gap-2 px-4 sm:gap-3 sm:px-6">
        ...
        >
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="start" className="max-h-[min(24rem,70vh)] w-56">
              {moreNav.map((item) => (
        ...
        <div className="relative z-30 ml-auto flex min-w-0 shrink-0 items-center gap-1 border-l border-border/60 pl-2 sm:gap-1.5 sm:pl-3">
