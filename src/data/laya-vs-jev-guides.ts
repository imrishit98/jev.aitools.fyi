  ...
  "migration-and-coexistence": {
    ...
    sections: [
      ...
      },
      {
        ...
        body:
          "Run Laya on-device or in a sidecar for cheap parallel questions (language detection, coarse routing, game ticks). Send only uncertain or high-stakes rows to hosted Jev. This preserves data minimization while keeping an authoritative cloud path for audit.",
      },
      {
